...
import 'package:get_well/core/providers/user/user_response.dart';
import '../../api/api.dart';
...
class UserProvider extends AppProvider {
  Future<UserResponse> getCreditCards() async {
    final response = await api.request(
      route: Uri.https(ApiEndpoints.host),
      method: Method.get,
      needToken: true,
      params: {},
    );
  ...
  Future<UserResponse> getUserData() async {
    final response = await api.request(
      route: Uri.https(ApiEndpoints.host, ApiEndpoints.getUserData),
      method: Method.get,
      needToken: true,
      params: {},
    );
  ...
  //   final response = await api.request(
  //     route: Uri.https(ApiEndpoints.host, ApiEndpoints.userUpdate),
  //     method: Method.post,
  //     needToken: true,
